...
namespace Content.Shared.Input
{
    ...
    public static class ContentKeyFunctions
    {
        ...
        public static readonly BoundKeyFunction FocusSubtleOOC = "FocusSubtleOOC"; // den
        public static readonly BoundKeyFunction FocusSign = "FocusSign"; // L5
        ...
        public static readonly BoundKeyFunction OperateCharacter =  "OperateCharacter"; // L5
