...
# L5
tips-dataset-141 = Turn off passive research probers when waste heat approaches cautious levels.
tips-dataset-142 = Passive research probers power themselves when waste heat gets too high.
...
tips-dataset-148 = Wisps will only attack you if they detect you are psionic, or you aggravate them by damaging them or dragging away a body they are trying to drain.
...
# L5
tips-dataset-151 = As a Peacekeeper, if you're not sure how to determine the severity of a crime or the appropriate punishment, take a look at the Crime Assist application in your PDA!
