## RoundEndSystem
# L5
round-end-system-shuttle-called-announcement = An evacuation shuttle has been sent. ETA: {$time} {$units}.
round-end-system-shuttle-already-called-announcement = An evacuation shuttle has already been sent.
...
round-end-system-shuttle-recalled-announcement = The evacuation shuttle has been recalled.
