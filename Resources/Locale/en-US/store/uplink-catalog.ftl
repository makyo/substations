...
uplink-antimov-law-name = Antimov Directive Circuit
uplink-antimov-law-desc = A very dangerous directive set to use when you want to cause the A.I. to go haywire, use with caution.
