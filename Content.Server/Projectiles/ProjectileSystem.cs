...
public sealed class ProjectileSystem : SharedProjectileSystem
{
    ...
    private void OnStartCollide(EntityUid uid, ProjectileComponent component, ref StartCollideEvent args)
    {
        ...
        if (_damageableSystem.TryChangeDamage((target, damageableComponent), ev.Damage, out var damage, component.IgnoreResistances, origin: component.Shooter) && Exists(component.Shooter))
        {
            ...
            component.ProjectileSpent = !TryPenetrate((uid, component), damage, damageRequired, target); // DeltaV - pass in target for NT-3
        }
        else
        {
    ...
    private bool TryPenetrate(Entity<ProjectileComponent> projectile, DamageSpecifier damage, FixedPoint2 damageRequired, EntityUid target) // DeltaV - pass in target for NT-3
    {
        ...
        RaiseLocalEvent(projectile.Owner, ref pierceEv);
        ...
        if (!projectile.Comp.ProjectileSpent)
        {
            ...
            if (projectile.Comp.ProjectileSpent && pierceEv.Pierced) // DeltaV - Addition of the NT-3
                projectile.Comp.ProjectileSpent = false;
        }
