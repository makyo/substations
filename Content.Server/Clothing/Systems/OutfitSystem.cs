...
public sealed class OutfitSystem : EntitySystem
{
    ...
    [Dependency] private readonly InternalEncryptionKeySpawner _encryption = default!;  // DeltaV/Goob (moved by L5 for refactor)
    ...
    public bool SetOutfit(EntityUid target, string gear, Action<EntityUid, EntityUid>? onEquipped = null, bool unremovable = false)
    {
        ...
        // Begin DeltaV/Goob Additions (moved by L5 for refactor)
