...
public sealed class AddWhitelistCommand : LocalizedCommands
{
    ...
    [Dependency] private readonly IPlayerManager _player = default!; // Nyanotrasen (updated by L5)
    [Dependency] private readonly PlayTimeTrackingManager _playtime = default!; // Nyanotrasen (updated by L5)
    ...
    public override async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        if (data != null)
        {
            ...
            if (_player.TryGetPlayerDataByUsername(name, out var playerData) &&
                _player.TryGetSessionByUsername(name, out var session))
            {
