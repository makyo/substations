...
public sealed partial class SupermatterEntryContainer : BoxContainer
{
    ...
    public SupermatterEntryContainer(NetEntity uid)
    {
        ...
        _radiationBase = _config.GetCVar(SMCCVars.SupermatterRadsBase);
        _temperatureLimitBase = Atmospherics.T0C + _config.GetCVar(SMCCVars.SupermatterHeatPenaltyThreshold);
        _wasteBase = 1f;
